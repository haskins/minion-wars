// attacker
// kills base first, then any discovered enemy
...
+!find : .my_name(N) & status(N,T,_,_) & status(E,A,b,H) & H > 0 & not T = A 										   <- .print("attempting to find"); !travel(E). //find any other units first
